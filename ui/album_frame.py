...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QRect(0, 0, 430, 76))
        ...
        self.layoutWidget_4.setGeometry(QRect(10, 10, 381, 56))
        ...
        self.Album_name.setMinimumSize(QSize(200, 23))
        self.Album_name.setMaximumSize(QSize(400, 23))
        font = QFont()
        font.setBold(True)
        ...
        self.Artist_name.setMinimumSize(QSize(200, 23))
        self.Artist_name.setMaximumSize(QSize(400, 23))
